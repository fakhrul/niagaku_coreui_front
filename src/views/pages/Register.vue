        ...
        <CCol md="8" lg="6">
          <CCard class="mx-4 mb-0">
            <CCardBody class="p-4">
              ...
              <!-- Additional images to attract users -->
              <div class="text-center mt-4">
                <!-- <img src="/img/signup-banner1.png" alt="Signup Benefits" class="img-fluid mb-3" style="max-height: 150px;" />
                <img src="/img/signup-banner2.png" alt="Join Our Community" class="img-fluid mb-3" style="max-height: 150px;" /> -->
              </div>
            </CCardBody>
          </CCard>
        </CCol>
