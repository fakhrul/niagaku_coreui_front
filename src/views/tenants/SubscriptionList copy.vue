            ...
            <CCardBody>
              ...
              >
                ...
                <template #details="{ item }">
                  ...
                  >
                    <CCardBody>
                      <p><strong>Subscription Plan:</strong> {{ item.packageDescription }}</p>
                      ...
                      <CButton
                        v-if="item.packageDescription === 'Free'"
                        size="sm"
                        color="success"
                        class="ml-1"
                        @click="upgradeToPro(item)"
                      >
                        Upgrade to PRO
                      </CButton>
                      <CButton
...
export default {
  ...
  methods: {
    ...
    upgradeToPro(item) {
      // Logic to handle upgrading to PRO package
      console.log("Upgrade to PRO clicked for", item);
      // You can call an API here or redirect to an upgrade page
      this.toast("Success", "Upgrade to PRO initiated!", "success");
    },
  },
};
</script>
